...
class TrialsControllerTest < ActionController::TestCase
  ...
  test "should create trial" do
    assert_difference('Trial.count') do
      post :create, trial: { claim: @trial.claim, defender_id: @trial.defender_id, ended_at: @trial.ended_at, prosecutor_id: @trial.prosecutor_id, title: @trial.title }
    end
  ...
  test "should update trial" do
    patch :update, id: @trial, trial: { claim: @trial.claim, defender_id: @trial.defender_id, ended_at: @trial.ended_at, prosecutor_id: @trial.prosecutor_id, title: @trial.title }
    assert_redirected_to trial_path(assigns(:trial))
  end
